 ...
 */
export type Bip44ChangeType = 'external' | 'internal';
...
export interface FullOwnership {
   ...
   * </details>
   */
  wallet_fullOwnership_getOffChainLocks(payload: { change?: Bip44ChangeType }): Promise<Script[]>;
   ...
   * </details>
   */
  wallet_fullOwnership_getLiveCells(payload?: { cursor?: Cursor; change?: Bip44ChangeType }): Promise<Paginate<Cell>>;
   ...
   *  });
   * ```
   * @param payload {@link https://github.com/nervosnetwork/rfcs/blob/master/rfcs/0019-data-structures/0019-data-structures.md#Transaction Transaction}
   ...
   * </details>
   */
  wallet_fullOwnership_signTransaction(payload: { tx: Transaction }): Promise<GroupedSignature>;
